...
export default function ProjectCard({ project }) {
  return (
    <div className="group flex flex-col overflow-hidden rounded-lg shadow-lg transition-all duration-200 hover:shadow-xl dark:bg-gray-800/50 dark:hover:bg-gray-800/80">
      ...
      <div className="flex flex-grow flex-col justify-between p-6">
        <div>
          <Link href={`/projects/${project.slug}`} aria-label={`View "${project.title}" project`}>
            <h2 className="text-xl leading-tight font-bold tracking-tight text-gray-900 dark:text-gray-100">
              {project.title}
            </h2>
          </Link>
