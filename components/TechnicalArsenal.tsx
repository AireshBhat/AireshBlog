  ...
  return (
    <div className="mb-12">
      ...
      <div className="grid gap-12 lg:grid-cols-2 mb-12">
        ...
        <div>
          <h3 className="mb-6 text-2xl font-bold text-gray-900">Languages & Core Skills</h3>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200">
              <h4 className="font-bold text-gray-900 mb-2">Systems Programming</h4>
              <p className="text-sm text-gray-700">
                <span className="font-bold text-pink-600">Rust (Advanced)</span> - Building performant, secure backend systems
              </p>
            </div>
            ...
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200">
              ...
              <p className="text-sm text-gray-700">
                <span className="font-bold text-pink-600">Solidity (Intermediate)</span> - DeFi, governance, and utility contracts
              </p>
            </div>

            {/* Full Stack */}
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200">
              <h4 className="font-bold text-gray-900 mb-2">Full Stack</h4>
              <p className="text-sm text-gray-700">
                <span className="font-bold text-pink-600">TypeScript (Advanced)</span> - End-to-end application development
              </p>
            </div>
            ...
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200">
              ...
              <p className="text-sm text-gray-700">
                <span className="font-bold text-pink-600">Git (Advanced)</span> - Collaborative development and CI/CD
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          <h3 className="mb-6 text-2xl font-bold text-gray-900">Blockchain Ecosystems</h3>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {/* Ethereum & L2s */}
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200 flex items-start space-x-3">
              <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center">
                {/* Ethereum Logo */}
                <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 320 512">
                  <path d="M311.9 260.8L160 353.6 8 260.8 160 0l151.9 260.8zM160 383.4L8 290.6 160 512l152-221.4-152 92.8z"/>
                </svg>
              </div>
              <div>
                <h4 className="font-bold text-gray-900 mb-1">Ethereum & L2s</h4>
                <p className="text-sm text-gray-700">Optimism, Arbitrum, Base</p>
              </div>
            </div>
            ...
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200 flex items-start space-x-3">
              <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center">
                {/* Database Icon */}
                <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 448 512">
                  <path d="M448 80v48c0 44.2-100.3 80-224 80S0 172.2 0 128V80C0 35.8 100.3 0 224 0S448 35.8 448 80zM393.2 214.7c20.8-7.4 39.9-16.9 54.8-28.6V288c0 44.2-100.3 80-224 80S0 332.2 0 288V186.1c14.9 11.8 34 21.2 54.8 28.6C99.7 230.7 159.5 240 224 240s124.3-9.3 169.2-25.3zM0 346.1c14.9 11.8 34 21.2 54.8 28.6C99.7 390.7 159.5 400 224 400s124.3-9.3 169.2-25.3c20.8-7.4 39.9-16.9 54.8-28.6V432c0 44.2-100.3 80-224 80S0 476.2 0 432V346.1z"/>
                </svg>
              </div>
              <div>
                <h4 className="font-bold text-gray-900 mb-1">Data Availability</h4>
                <p className="text-sm text-gray-700">Celestia, Avail</p>
              </div>
            </div>
            ...
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200 flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-1">Alternative L1s</h4>
                <p className="text-sm text-gray-700">Cosmos, Polkadot</p>
              </div>
            </div>
            ...
            <div className="rounded-lg p-4 bg-gray-50 border border-gray-200 flex items-start space-x-3">
              <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center">
                {/* Bitcoin Icon */}
                <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 512 512">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-1">Bitcoin L2s</h4>
                <p className="text-sm text-gray-700">Arbitrum, Lightning Network</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mb-12">
        <h3 className="mb-6 text-2xl font-bold text-gray-900">Infrastructure & Architecture</h3>
        <div className="grid gap-6 md:grid-cols-3">
          {/* Decentralised */}
          <div className="relative">
            <div className="bg-gray-100 border border-gray-200 p-6 relative overflow-hidden">
              {/* Arrow shape using clip-path */}
              <div
                className="absolute inset-0 bg-gray-100 border-r border-gray-300"
                style={{
              ...
              <div className="relative z-10 flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-2">Decentralised</h4>
                  <p className="text-sm text-gray-700">IPFS, Libp2p, The Graph, WebSocket Management</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-100 border border-gray-200 p-6 relative overflow-hidden">
              ...
              <div className="relative z-10 flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">AWS, DigitalOcean, PostgreSQL, Redis</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="bg-gray-100 border border-gray-200 p-6 relative overflow-hidden">
              ...
              <div className="relative z-10 flex items-start space-x-3">
                <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center">
                  {/* Mercury/Hybrid Icon */}
                  <svg className="w-6 h-6 text-gray-600" fill="currentColor" viewBox="0 0 384 512">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">Event-Driven Architecture, Microservices, API Gateway patterns</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div>
        <h3 className="mb-6 text-2xl font-bold text-gray-900">Frameworks & Tools</h3>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-lg p-4 bg-white border-2 border-gray-200">
            ...
            <p className="text-sm text-gray-700">Polkadot SDK, Hardhat, Foundry</p>
          </div>

          {/* Backend */}
          <div className="rounded-lg p-4 bg-white border-2 border-gray-200">
            <h4 className="font-bold text-gray-900 mb-2">Backend</h4>
            <p className="text-sm text-gray-700">Actix-Web (Rust), Express/NestJS (Node)</p>
          </div>

          {/* Frontend */}
          <div className="rounded-lg p-4 bg-white border-2 border-gray-200">
            <h4 className="font-bold text-gray-900 mb-2">Frontend</h4>
            <p className="text-sm text-gray-700">ReactJS, Next.js, React Native, Tauri</p>
          </div>

          {/* Emerging */}
          <div className="rounded-lg p-4 bg-white border-2 border-gray-200">
            <h4 className="font-bold text-gray-900 mb-2">Emerging</h4>
            <p className="text-sm text-gray-700">Iroh, Earthstar (distributed systems)</p>
          </div>
        </div>
      </div>
    </div>
