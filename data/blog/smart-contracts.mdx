...
description: 'A post on Smart Contracts and how they are stored on the Ethereum Blockchain'
pubDate: 'Oct 10 2021'
heroImage: '../../assets/images/Cytonn-Photography.jpg'
category: 'Web3'
...
<image src='/images/smart-contracts/Compiling-smart-contract-1.png' alt='' />
![Compiling a Smart Contract](../../assets/images/Compiling-smart-contract.png)
...
![Smart Contract Transaction](../../assets/images/Transaction-Smart-Contract.png)
...
This article was originally published on [Medium](https://medium.com/@asper9/smart-contracts-a194da695a68).
