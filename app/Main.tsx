  ...
  return (
    <>
      ...
      <div className="hero-section relative min-h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 bg-gradient-to-b from-black/60 via-black/40 to-black/70 bg-stone-100/30 p-8 backdrop-blur-sm"></div>
              ...
              <div className="lg:flex-1">
                ...
                <div className="rounded-lg bg-brand-card/30 p-6 backdrop-blur-sm">
                  <p className="text-white">
                    ...
                    swadeshi economy that empowers every Indian citizen to express their unique <a href="https://www.chiti.network" className="text-brand-accent">Chiti</a> through sovereign digital
                    infrastructure.
                  </p>
                </div>
              </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-brand-accent text-brand-card">
                    <span className="text-sm font-bold">01</span>
                  </div>
                  <div className="flex-1">
                    <h4 className="mb-2 font-semibold text-brand-text">Deploying production-ready Chiti-Agent</h4>
                    <p className="text-sm leading-relaxed text-brand-text">Building for ONDC ecosystem integration</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-brand-accent text-brand-card">
                  ...
                  <div className="flex-1">
                    <h4 className="mb-2 font-semibold text-brand-text">Building Web-of-Trust infrastructure</h4>
                    <p className="text-sm leading-relaxed text-brand-text">Targeting 1 million+ users</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-brand-accent text-brand-card">
                  ...
                  <div className="flex-1">
                    <h4 className="mb-2 font-semibold text-brand-text">Contributing to India's CBDC initiatives</h4>
                    <p className="text-sm leading-relaxed text-brand-text">Supporting digital rupee development</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-8">
              ...
              <div>
                ...
                <p className="mb-6 text-sm leading-relaxed text-brand-text">
                  Creating the technological foundation for a truly decentralised Bharat where:
                </p>
                <div className="space-y-4">
                  <div className="flex items-center gap-4 rounded-lg bg-brand-bg p-4">
                    <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white shadow-sm">
                      <span className="text-xl">👁️</span>
                    </div>
                    <div className="flex-1">
                      <h4 className="font-semibold text-brand-text">Digital Sovereignty</h4>
                      <p className="text-sm text-brand-text">Every citizen owns their digital identity and data</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 rounded-lg bg-brand-bg p-4">
                    <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white shadow-sm">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-brand-text">Financial Freedom</h4>
                      <p className="text-sm text-brand-text">Financial services accessible without intermediaries</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 rounded-lg bg-brand-bg p-4">
                    <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white shadow-sm">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-brand-text">Local Economies</h4>
                      <p className="text-sm text-brand-text">Communities thrive through peer-to-peer digital infrastructure</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 rounded-lg bg-brand-bg p-4">
                    <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-white shadow-sm">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-brand-text">Technology for Dharma</h4>
                      <p className="text-sm text-brand-text">Technology serves dharma, not just profit</p>
                    </div>
                  </div>
                </div>
              </div>
